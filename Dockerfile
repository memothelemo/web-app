...
RUN wget "https://github.com/memothelemo/web-app/releases/download/v0.1.8/backend-bin-heroku"
RUN wget "https://github.com/memothelemo/web-app/releases/download/v0.1.8/backend-bin-heroku.sig"
