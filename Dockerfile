...
RUN wget "https://github.com/memothelemo/web-app/releases/download/v0.1.6/backend-bin"
RUN wget "https://github.com/memothelemo/web-app/releases/download/v0.1.6/backend-bin.sig"
