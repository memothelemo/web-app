...
RUN wget "https://github.com/memothelemo/web-app/releases/download/v0.1.5/backend-bin"
RUN wget "https://github.com/memothelemo/web-app/releases/download/v0.1.5/backend-bin.sig"
